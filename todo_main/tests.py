...
class TodoListTestCase(TestCase):
    def setUp(self):
        ...
        models.todo.objects.create(title = "Test1",
...
class TodoTodoDetailTestCases(TestCase):
    ...
    def test_update(self):
        updated_data = {
            ...
            "due_date": "2024-01-01",
            "status": "DONE"}
        response = self.client.put(f'/todo/{self.test1.id}/', updated_data, format='json')
        self.assertEqual(response.status_code, status.HTTP_200_OK)
        ...
        updated_err_data = {
            ...
            "due_date": "2024-01-01",
            "status": "DONE"}
        response2 = self.client.put(f'/todo/{self.test1.id}/', updated_err_data, format='json')
